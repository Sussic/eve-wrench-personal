...
use evesettings::{
    ...
    delete_backups, execute_import, export_probe_formation, export_probe_formations,
    export_settings, get_app_data, get_entry_display_name, import_probe_formation, is_eve_running,
